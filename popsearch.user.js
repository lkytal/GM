...
Init = function() {
  ...
  $('#popupwapper').append("<a id='gtrans' href='javascript:void(0)'><img src='" + ticon + "'></img></a>").append("<a id='openurl' href=''><img id='iconie' src='" + ie + "'></img></a>").append("<a id='sbaidu' href=''><img src='" + baiduico + "'></img></a>").append("<a id='sbing' href=''><img src='" + bingicon + "'></img></a>").append("<a id='sgoogle' href=''><img id='gicon' src='" + gicon + "'></img></a>");
