...
"use strict";
var GetOpt, Init, Load, OpenSet, SaveOpt, SetOpt, SettingWin, ShowBar, TimeOutHide, fixPos, getLastRange, get_offsets_and_remove, get_selection_offsets, popData;
...
Init = function() {
  ...
  $('#popupwapper').append("<a id='gtrans' href='javascript:void(0)'><img title='translate' src='" + popData.tico + "'></img></a>").append("<a id='openurl' href=''><img title='Open Url' id='iconie' src='" + popData.ieIcon + "'></img></a>").append("<a id='sbaidu' href=''><img title='Baidu' src='" + popData.baiduico + "'></img></a>").append("<a id='sbing' href=''><img title='Bing' src='" + popData.bingico + "'></img></a>").append("<a id='sgoogle' href=''><img title='Google' id='popData.gicon' src='" + popData.gicon + "'></img></a>");
  ...
  $('#gtrans').on("click", function(event) {
    ...
    return GM_xmlhttpRequest({
      method: 'POST',
      url: 'http://198.58.115.149/translate_a/t',
...
ShowBar = function() {
  var InTextBox, UrlText, event, sel, seltxt;
  event = popData.lxe;
  ...
  $('#sgoogle').attr('href', "https://www.google.com.hk/search?newwindow=1&q=" + popData.text);
  UrlText = seltxt;
