...
OpenSet = function() {
  ...
  return $('#popup_setting_win').fadeIn(300);
};
...
SettingWin = function() {
  ...
  $("#popup_save").click(function() {
    var _j, _len1, _ref1;
    _ref1 = $("#popup_setting_win .setting_sp_btn");
    for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
      item = _ref1[_j];
      if (item != null) {
        SaveOpt(item.id);
