...
TailInit = function() {
  ...
  if (document.querySelector(".ui_btn.ui_btn_m.j_submit.poster_submit")) {
    ...
    window.AddTail = function(e) {
      ...
      tailContent = void 0;
      if (tail_data[tail_cur].split("!分隔!")[1] === "html") {
        tailContent = tail_data[tail_cur].split("!分隔!")[0];
      } else {
        if (tail_data[tail_cur].split("!分隔!")[1] === "javascript") {
          tailContent = eval_(tail_data[tail_cur].split("!分隔!")[0]);
        }
      }
